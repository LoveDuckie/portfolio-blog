...
arg_parser_group_publish.add_argument('--publisher', type=str, action='append', required=False)

arg_parser_group_export = arg_parser.add_argument_group("Export")
arg_parser_group_export.add_argument('--export-path', type=str, help='The absolute path for exported blogs (HTML format).', default=get_default_export_path())
...
arg_parser_group_create.add_argument('--blog-series-name', type=str, help='The name of the blog series', default=None, required=False)
